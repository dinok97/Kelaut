...
class ConfirmationDialog(
    ...
    class Builder(var context: Context) {
        ...
        fun setCancelOutside(_cancelOutside: Boolean) =
            apply { this.cancelOutside = _cancelOutside }
    ...
    init {
        ...
        val titleTxt = dialog.findViewById<TextView>(R.id.tv_dialog_title)
        val contentTxt = dialog.findViewById<TextView>(R.id.tv_dialog_content)
        val cancelLyt = dialog.findViewById<TextView>(R.id.btn_cancel)
        val okLyt = dialog.findViewById<TextView>(R.id.btn_ok)
